...
$blog_posts_home_image = $andorra_theme_options['blog_posts_home_image'];
$blog_posts_top_image = $andorra_theme_options['blog_posts_top_image'];
if ( have_posts() ) : ?>
<div class="clear"></div>
		...
		<div class="standard-posts-wrapper">
			<div class="posts-wrapper">	
				<div id="post-body">
					...
					endwhile; 		
					if ($andorra_theme_options['simple_paginaton'] == '1') {			
