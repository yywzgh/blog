                            ...
                            <div class="happy_items clearfix">
                                ...
                                if (have_posts()) :
                                    ...
                                    <article <?php post_class('post'); ?>>
                                            ...
                                            <h2><?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'silvana'); ?></h2>
                                       
                                        <div class="post-entry text-left">
                                            <div class="post-entry-read text-center col-md-12 ">
                                                <?php get_search_form(); ?>
                                            </div>
                                        </div>
